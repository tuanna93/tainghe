                  ...
                  <table id="datatable-keytable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>{{ $pro->name }}</td>
                        <td>{{ get_cate_product($pro->cate_id) }}</td>
                        <td>{{ get_time($pro->created_at) }}</td>
                        <td>
                          <div class="vina_price">
                            <span class="jshop_price"> <span>{{ get_price_product($pro->price_new) }}</span> </span>
                            @if($pro->price_old)
                            - <span class="old_price"><span>{{ get_price_product($pro->price_old) }} </span></span>
                            @endif
                            Đ
                          </div>
                        </td>
                        <td>{!! check_label_product($pro->status_sale) !!}</td>
                        <td>{!! check_status_active($pro->status) !!}</td>
