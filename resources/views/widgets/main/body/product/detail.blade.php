                                    ...
                                    <div class="detailsLeft">
                                        ...
                                        <div class="product_image_middle">
                                            ...
                                            <div class="product_label">
                                                <{!! check_image_sale($detail->status_sale) !!}
                                            </div>
                                    ...
                                    <div class="buy_block">
                                        ...
                                        <div class="prod_buttons" style="">
                                            ...
                                            <span class="prod_qty_input">
									            <input type="text" name="quantity" id="quantity" class="inputbox" value="{{ get_qty_cart($detail->id) }}">
                                            </span>
                                            <span class="btn_add">
                    ...
                    <div class="tab-block">
                        ...
                        <div class="jshop list_related">
                            <div class="flexslider_related">
                                    <ul class="slides">
                                        @foreach(get_product_involve($detail->cate_id) as $pro)
